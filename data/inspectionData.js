  ...
  front: {
    ...
    points: [
      ...
      },
      {
        ...
        specificPrompt: 'Inspect the front left tire for flats, sidewall damage, uneven tread wear, cords showing, and valve stem condition. Inspect rim for cracks, bent sections, missing or loose lug bolts/nuts.',
      ...
      },
      {
        ...
        imageType: 'tires_rims',
        specificPrompt: 'Inspect the front right tire for flats, sidewall damage, uneven tread wear, cords showing, and valve stem condition. Inspect rim for cracks, bent sections, missing or loose lug bolts/nuts.',
  ...
  front_left: {
    ...
    points: [
      ...
      },
      {
        ...
        imageType: 'tires_rims',
        specificPrompt: 'Close-up inspection of front left tire tread, sidewall, and rim. Look for uneven wear pattern, cracks, bulging sidewall, broken lug bolts, and rim deformation.',
        referenceImage: require('../assets/Wheel_Loader_982m_Photos/FL_Wheel.jpg'),
      },
    ],
  },
  ...
  front_right: {
    ...
    points: [
      ...
      },
      {
        ...
        imageType: 'tires_rims',
        specificPrompt: 'Close-up inspection of front right tire and rim. Look for uneven tread wear, sidewall damage, bulging, cords showing, and rim cracks or loose lug hardware.',
        referenceImage: require('../assets/Wheel_Loader_982m_Photos/FR_Wheel.jpg'),
      },
    ],
  },
  ...
  right_side: {
    ...
    points: [
      ...
      },
      {
        ...
        position: { x: 0.80, y: 0.78 },
        imageType: 'tires_rims',
        specificPrompt: 'Inspect the rear right tire for flat, sidewall damage, and tread wear. Check rim for cracks and missing lug bolts.',
        referenceImage: require('../assets/Wheel_Loader_982m_Photos/RF.jpg'),
      },
    ],
  },
    ...
    points: [
      {
        ...
        imageType: 'tires_rims',
        specificPrompt: 'Inspect rear left tire for flat, sidewall cracks, severe tread wear, or bulging. Check rim for cracks, bent sections, and missing or loose lug bolts.',
      ...
      },
      {
        ...
        imageType: 'tires_rims',
        specificPrompt: 'Inspect rear right tire for flat, sidewall cracks, severe tread wear, or bulging. Check rim for cracks and loose lug bolts.',
  ...
  fl_wheel: {
    ...
    points: [
      ...
      },
      {
        ...
        imageType: 'tires_rims',
        specificPrompt: 'Inspect front left rim for cracks, weld failures, bent sections, heavy corrosion, and all lug bolts for presence, tightness, thread damage, or stripped nuts.',
        referenceImage: require('../assets/Wheel_Loader_982m_Photos/FL_Wheel.jpg'),
      },
    ],
  },
  ...
  fr_wheel: {
    ...
    points: [
      ...
      },
      {
        ...
        position: { x: 0.50, y: 0.70 },
        imageType: 'tires_rims',
        specificPrompt: 'Inspect front right rim for cracks, deformation, corrosion, and lug bolt integrity.',
        referenceImage: require('../assets/Wheel_Loader_982m_Photos/FR_Wheel.jpg'),
      },
    ],
  },
