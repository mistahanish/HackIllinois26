  ...
  front: {
    ...
    points: [
      ...
      },
      {
        ...
        specificPrompt: 'Front left wheel. Check tire sidewall and tread for flats, cracks, uneven wear, and exposed cords. Check rim for cracks, bent sections, and missing or broken lug bolts. Check valve stem.',
      ...
      },
      {
        ...
        imageType: 'tires_rims',
        specificPrompt: 'Front right wheel. Check tire sidewall and tread for flats, cracks, uneven wear, and exposed cords. Check rim for cracks, bent sections, and missing or broken lug bolts. Check valve stem.',
  ...
  front_left: {
    ...
    points: [
      ...
      },
      {
        ...
        imageType: 'tires_rims',
        specificPrompt: 'Close-up of front left rim and tire. Look for missing or broken lug bolts, rim cracks or deformation, sidewall damage, bulging, uneven tread wear, and cords showing.',
        referenceImage: require('../assets/Wheel_Loader_982m_Photos/FL_Wheel.jpg'),
      },
    ],
  },
  ...
  front_right: {
    ...
    points: [
      ...
      },
      {
        ...
        imageType: 'tires_rims',
        specificPrompt: 'Close-up of front right rim and tire. Look for missing or broken lug bolts, rim cracks or deformation, sidewall damage, bulging, uneven tread wear, and cords showing.',
        referenceImage: require('../assets/Wheel_Loader_982m_Photos/FR_Wheel.jpg'),
      },
    ],
  },
  ...
  right_side: {
    ...
    points: [
      ...
      },
      {
        ...
        position: { x: 0.80, y: 0.78 },
        imageType: 'tires_rims',
        specificPrompt: 'Rear right wheel. Check tire for flat, sidewall damage, severe tread wear, and exposed cords. Check rim for cracks, bent sections, and missing or broken lug bolts.',
        referenceImage: require('../assets/Wheel_Loader_982m_Photos/RF.jpg'),
      },
    ],
  },
    ...
    points: [
      {
        ...
        imageType: 'tires_rims',
        specificPrompt: 'Rear left wheel. Check tire for flat, sidewall cracks, severe tread wear, bulging, and exposed cords. Check rim for cracks, bent sections, and missing or broken lug bolts.',
      ...
      },
      {
        ...
        imageType: 'tires_rims',
        specificPrompt: 'Rear right wheel. Check tire for flat, sidewall cracks, severe tread wear, bulging, and exposed cords. Check rim for cracks, bent sections, and missing or broken lug bolts.',
  ...
  fl_wheel: {
    ...
    points: [
      ...
      },
      {
        ...
        imageType: 'tires_rims',
        specificPrompt: 'Close-up of front left rim and lug bolts. Inspect for missing, broken, or sheared lug bolts; rim cracks, weld failures, bent sections; and heavy corrosion affecting structural integrity.',
        referenceImage: require('../assets/Wheel_Loader_982m_Photos/FL_Wheel.jpg'),
      },
    ],
  },
  ...
  fr_wheel: {
    ...
    points: [
      ...
      },
      {
        ...
        position: { x: 0.50, y: 0.70 },
        imageType: 'tires_rims',
        specificPrompt: 'Close-up of front right rim and lug bolts. Inspect for missing, broken, or sheared lug bolts; rim cracks, deformation, and heavy corrosion affecting structural integrity.',
        referenceImage: require('../assets/Wheel_Loader_982m_Photos/FR_Wheel.jpg'),
      },
    ],
  },
